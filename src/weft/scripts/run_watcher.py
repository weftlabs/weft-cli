...
def main() -> None:
    ...
    ai_history_path_str = os.getenv("WEFT_AI_HISTORY_PATH") or os.getenv("AI_HISTORY_PATH")
    ...
    poll_interval_str = os.getenv("WEFT_POLL_INTERVAL") or os.getenv("POLL_INTERVAL") or "5"
