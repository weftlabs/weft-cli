...
class ClaudeBackend(AIBackend):
    def __init__(self, api_key: str, model: str = "claude-3-5-sonnet-20241022", **kwargs):  # type: ignore[no-untyped-def]
...
def create_backend(backend_type: str, **kwargs) -> AIBackend:  # type: ignore[no-untyped-def]
